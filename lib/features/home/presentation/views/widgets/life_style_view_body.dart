...
class LifeStyleViewBody extends StatefulWidget {
  const LifeStyleViewBody({super.key});

  @override
  State<LifeStyleViewBody> createState() => _LifeStyleViewBodyState();
}

class _LifeStyleViewBodyState extends State<LifeStyleViewBody> {
  @override
  void initState() {
    super.initState();
